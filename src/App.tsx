...
function App() {
  ...
  // Автоматический пересчёт с debounce
  ...
  // Первоначальный запуск и синхронизация с URL
  useEffect(() => {
  ...
  // Расчёт экономики и экологии при изменении результатов
  useEffect(() => {
    if (results) {
          ...
          {activeTab === 'params' && (
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="space-y-4">
                  {/* Блоки информации (без изменений) */}
