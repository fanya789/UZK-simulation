  ...
  return (
      <div className="space-y-5">
        ...
        <div className="flex gap-3">
          <button
              onClick={onSimulate}
              className="flex-1 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 text-white font-bold py-3 px-6 rounded-xl transition-all transform hover:scale-[1.02] active:scale-95 shadow-lg shadow-blue-900/30"
          >
            ▶ Запустить моделирование
          </button>
          <button
              onClick={onReset}
              className="bg-slate-700 hover:bg-slate-600 text-slate-200 font-bold py-3 px-6 rounded-xl transition-all transform hover:scale-[1.02] active:scale-95"
          >
            🔄 Сбросить
          </button>
        </div>
...
const ParamSlider: React.FC<{
  ...
  return (
      <div className="mb-3" title={`Диапазон: ${min}…${max} ${unit}`}>
